...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <nav class="main-menu">
            <div class="container-fluid">
                <div class="main-menu__logo">
                    ...
                    <a href="/">
                        <img src="assets/images/logo-dark.png" width="140" height="51" alt="Urgentrupee" loading="lazy">
                    </a>
                </div>
        ...
        <section class="contact-one pt-120 pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="contact-one__content">
                            <div class="block-title">
                                ...
                                <h2 class="block-title__title">Asking Any Query</h2>
                            </div>
                            <p class="contact-one__text">At Urgentrupee, we take a proactive approach, understanding
                                that obtaining financial independence can be a difficult and sometimes intimidating
                                road. </p>
                    ...
                    <div class="col-lg-8">
                        <form action="" method="post" enctype="multipart/form-data" id="form1" class="contact-form"
                            class="form-one contact-form-validated">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="contact-info-one__item">
                            ...
                            <div class="contact-info-one__content">
                                ...
                                <a class="contact-info-one__link" href="tel:9643003906">+91-9643-003-906</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="contact-info-one__item">
                            ...
                            <div class="contact-info-one__content">
                                <p class="contact-info-one__text">Write us email</p>
                                <a class="contact-info-one__link"
                                    href="mailto:help@urgentrupee.com">help@urgentrupee.com</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="contact-info-one__item">
                            ...
                            <div class="contact-info-one__content">
                                ...
                                <a class="contact-info-one__link" href="#">Chhatarpur, New Delhi - 110074</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="google-map__default">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3506.415144119693!2d77.18347227549592!3d28.497154975738887!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjjCsDI5JzQ5LjgiTiA3N8KwMTEnMDkuOCJF!5e0!3m2!1sen!2sin!4v1700907262803!5m2!1sen!2sin"
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="000ms" data-wow-duration="1500ms">
                        <div class="call-to-action-two__image">
                            <img src="assets/images/backgrounds/cta-2-1-bg.webp" alt="" loading="lazy">
                        </div>
                    </div>
                    <div class="col-lg-6">

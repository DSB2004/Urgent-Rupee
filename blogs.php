        ...
        <section class="blog-card-section">
            ...
            if (!empty($data)) {
                ...
                foreach ($data as $item) {
                    ...
                    echo '<img class="blog-card-img" src="' . $img . '" alt="' . $heading . '">';
                    echo '<div class="tag-card-div">';
                    foreach ($tags as $tag) {
                        echo '<div class="tag-card">' . $tag . '</div>';
                    }
                    echo '</div>';
                    // // Continue echoing HTML without closing PHP tags
                    echo '<h2 class="blog-card-header">' . $heading . '</h2>';
                    // echo '<p class="blog-card-intro">' . $intro . '</p>';
                    echo '<div class="blog-card-info-div">';
                    echo '<p class="blog-card-by"> By: ' . $by . '</p>';
                    echo '<p class="blog-card-date">' . $date . '</p>';
                    echo '</div>';
                    // echo '<a>CLICK</a>';
                    echo '<a class="view-more-btn" href="blog.php?id=' . $id . '">View Blog</a>';
                    echo '</div>'; // Close card
                }
            } else {

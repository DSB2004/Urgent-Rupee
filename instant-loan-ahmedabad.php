    ...
    <div class="page-wrapper">
        ...
        <nav class="main-menu">
            <div class="container-fluid">
                <div class="main-menu__logo">
                    ...
                    <a href="/">
                        <img src="assets/images/logo-dark.png" loading="lazy" width="140" height="51" alt="Urgentrupee">
                    </a>
                </div>
        ...
        <section class="page-header">
            <div class="page-header__bg"
                style="background-image: url(assets/images/backgrounds/ahmedabad-background.webp);"></div>
            <div class="container">
                <ul class="thm-breadcrumb list-unstyled">
                    <li><a href="/">Home</a></li>
                    <li><span>Instant Loan Ahmedabad</span></li>
                </ul>
                <!-- <h1>Contact us</h1> -->
            </div>
        </section>
